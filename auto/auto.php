    ...
    <section class="AutoDisplay" id="app">
      <div class="row row-cols-2">
              ...
              <div class="col-md mainMenuBackground">
                <div class="row">
                  <button class="btn btn-success btn-sm m-2 ms-4 col-1" @click="this.navbaron = true" v-if="!navbaron && !show">Filtri</button>
                  <div class="btn-toolbar justify-content-end col" role="toolbar" aria-label="Toolbar with button groups" v-if="!show">
                ...
                <div class="row">
                  ...
                  <div class="container m-3" v-else="">
                    ...
                    <div class="container">
                      ...
                      <div class="row">
                          <div class="col" id="frame"><img :src="scopri.immagini[0]" style="height: 100%; width: 100%;">
                          </div>
                          <div class="col mt-4">
                            <ul>
